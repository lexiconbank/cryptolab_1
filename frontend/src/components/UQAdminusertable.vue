        ...
        <div>
            ...
            >
                <template v-slot:top="props">
                    <q-btn name="role" label="Role" @click="openModal('role')"/>
                    <q-btn name="add" label="Add New" @click="openModal('add')"/>
                ...
                <template v-slot:body="props">
                    <q-tr :props="props">
                        ...
                        <q-td>
                            <q-btn size="sm" color="primary" icon="edit" @click="openModal('update', props.row)"/>
                            <q-btn size="sm" color="negative" icon="delete" @click="deleteThis(props.row)"/>
                        </q-td>
                    </q-tr>
                </template>
            </q-table>
            
            <q-dialog v-model="modal" @keyup.esc="closeModal()">  
                <div v-if="this.modal_content == 'role'">
                    <q-card>
                        ...
                        <q-card-actions>
                            <q-btn outlined label="Save" @click="validate()"></q-btn>
                        </q-card-actions>
                    </q-card>
                            ...
                            >
                                ...
                                <template v-slot:body="props">
                                    <q-tr :props="props">
                                        ...
                                        <q-td>
                                            <q-btn size="sm" color="primary" icon="edit" @click="dataToRoleForm(props.row)"/>
                                            <q-btn size="sm" color="negative" icon="delete" @click="deleteThis(props.row)"/>
                                        </q-td>
                                    </q-tr>
                                </template>
                        ...
                        <q-card-section>
                            <q-form class="field"> 
                                ...
                                <div class="col-12 q-mt-md">
                                    <q-btn outlined style="color: #1976D2;" size="18px" class="full-width" label="Submit" @click="validate()"/>
                                </div>
                            </q-form>
                        </q-card-section>
                    </q-card>
